...
INSERT INTO st_passport_office (p_office_id, p_office_area_id, p_office_name) VALUES
...
(4, '010030000000', 'Паспортный стол района 3 города'),
(5, '020010010001', 'Паспортный стол область 1 поселения 1'),
(6, '020010010002', 'Паспортный стол область 1 поселения 2'),
(7, '020020010000', 'Паспортный стол область 2 район 1'),
(8, '020020020000', 'Паспортный стол область 2 район 2');

INSERT INTO st_register_office (r_office_id, r_office_area_id, r_office_name) VALUES
